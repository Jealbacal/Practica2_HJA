...
//       }
        ...
        while ( j < range2Text.size()){
            ...
            //comprobaciones del Suited y los Offs
                ...
                //3-el final del rango llega al final del array
                if( cartaParse(rngIN.charAt(1))-cartaParse(rngF.charAt(1))>1 && rngI != rngIN || j>= range2Text.size() || (cartaParse(rngIN.charAt(0))!= cartaParse(rngF.charAt(0)) && rngI != rngIN) || (rngIN.charAt(2)!=rngF.charAt(2)&& rngI != rngIN)){
